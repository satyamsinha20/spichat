  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4">
        <div className="w-full max-w-lg bg-slate-900 rounded-2xl shadow-lg p-8 border border-slate-800/80">
          <h1 className="text-2xl font-semibold mb-1 text-center">
            Create an account ✨
          </h1>
          <p className="text-sm text-slate-400 mb-6 text-center">
            Join the real-time chat on spichat
          </p>
          ...
          >
            ...
            <div className="md:col-span-2">
              <label className="block text-sm mb-1">
                Profile picture URL (abhi ke liye)
              </label>
              <input
                name="profilePic"
                className="w-full bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                name="bio"
                rows="3"
                className="w-full resize-none bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                value={form.bio}
                onChange={handleChange}
              />
            </div>
            ...
            <button
              disabled={loading}
              type="submit"
              className="md:col-span-2 w-full py-2 rounded-lg text-sm font-medium bg-indigo-600 hover:bg-indigo-500 disabled:opacity-60 disabled:cursor-not-allowed transition"
            >
